...
public partial class BookDoc_Admin_Del_Hdoctors : System.Web.UI.Page
{
    ...
    public void hospital_doctor()
    {
        ...
        con.Open();
        SqlDataAdapter Sda = new SqlDataAdapter("Select * from tbl_temp_hdoctor order by id desc", con);
