<%@ Page Title="" Language="C#" MasterPageFile="~/BookDoc Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="doctor_review.aspx.cs" Inherits="BookDoc_Admin_doctor_review" %>
                    ...
                    <asp:GridView ID="GridView1" CssClass="table table-bordered" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="13" OnDataBound="GridView1_DataBound" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowCommand="GridView1_RowCommand" >
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Doctor Name" >
                                <ItemTemplate>
                                    <asp:Label ID="Label9" runat="server" Text='<%# Bind("d_name") %>' ></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
