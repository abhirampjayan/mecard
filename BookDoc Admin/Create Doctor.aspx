<%@ Page Title="" Language="C#" MasterPageFile="~/BookDoc Admin/AdminMaster.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Create Doctor.aspx.cs" Inherits="BookDoc_Admin_Create_Doctor" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    { %>
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    <label>
                        <asp:Label ID="Label7" runat="server" Text="Contact phone number" meta:resourcekey="Label7Resource1"></asp:Label></label>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ForeColor="Red" ValidationGroup="a" ControlToValidate="phone" runat="server" ErrorMessage="* Enter contact number" Display="Dynamic" meta:resourcekey="RequiredFieldValidator2Resource1"></asp:RequiredFieldValidator>
                     <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"  
ControlToValidate="phone" ForeColor="Red" ValidationGroup="a" ErrorMessage="* Enter valid phone number"  
ValidationExpression="\d+"></asp:RegularExpressionValidator>  
                    <div class="auto-style1">
                      ...
                      <%--  <i class="fa">
                        ...
                        <asp:TextBox ID="phone" CssClass="form-control" ValidationGroup="a" runat="server" meta:resourcekey="phoneResource1" placeholder="Enter Phone Number" MaxLength="10"></asp:TextBox><span id="mypopup" class="popuptext"></span>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
                    <%-- <div class="form-group">
    ...
    { %> <div class="pull-left">
         ...
         <asp:Button ID="btn_cancel" runat="server"  CssClass="btn btn-sm btn-primary pull-right" Style="margin:5px;" Text="Cancel" meta:resourcekey="btn_cancelResource1" OnClick="btn_cancel_Click"  />
                        <asp:Button ID="Button1" runat="server" ValidationGroup="a"  CssClass="btn btn-sm btn-primary pull-right" Style="margin:5px;" Text="Create doctor" OnClick="Button1_Click" meta:resourcekey="Button1Resource1" />
