...
public partial class BookDoc_Admin_Create_Doctor : System.Web.UI.Page
{
    ...
    public void Doctor()
    {
        try
        {
            ...
            {
                var Query = from item in db.tbl_doctors where item.d_hakkimid == Session["d_id"].ToString() select item;
                foreach (var ss in Query)
                {
                    ...
                    dnumber.Text = ss.d_id_number.ToString();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (Session["d_id"] != null && Session["d_id"].ToString() != "")
        {
            ...
            //{
                ...
                SqlDataAdapter adpt = new SqlDataAdapter("select d_id from tbl_doctor where d_hakkimid='" + Session["d_id"].ToString() + "'", con);
                DataSet dts = new DataSet();
                dts.Clear();
                adpt.Fill(dts);
                Session["d_id"] = dts.Tables[0].Rows[0][0].ToString();
                ...
                else
                {
                    ...
                    if ((DateTime.Parse(compareDate.ToShortDateString()) - DateTime.Parse(DateTime.Now.ToShortDateString())).TotalDays < 30)
                    {
                        ...
                        //}
                        //string msg = "Successfully Updated your Hakkeem account, so you can act as a doctor in Hakkeem. Using following link to signin " + "http://www.hakkeem.com" + " and your loging password is " + pswd;
                        ...
                        //RegisterStartupScript("", "<Script Language=JavaScript>alert('Successfully Updated doctor and " + message + "')</Script>");
                        ...
                        Email_To_ApproveDoctor(email);
                            ...
                            //ClientScript.RegisterStartupScript(this.GetType(), "Success", "<Script Language=JavaScript>swal('Successfully Updated doctor')</Script>");
                            //if (Session["Language"].ToString() == "Auto")
                            //{
                                Label1.Text = "Successfully Updated doctor and " + message;
                            //}
                            //else
                            //{
                        ...
                        else
                        {
                            ...
                            if (FileUpload2.HasFile)
                            {
                                ...
                                //string msg = "Successfully Updated your Hakkeem account, so you can act as a doctor in Hakkeem. Using following link to signin " + "http://www.goldenetqan.com" + " and your loging password is " + pswd;
                                ///  string msg = "Dear doctor, your Hakkeem account is approved by Hakkeem authority." + "<p>Thank you. Hakkeem Team</p>";
                                ////   Email.mail(email, msg, "Doctor registration");
                                string pno = "+966" + ph.ToString();
                                ob1.Message(pno.ToString(), "Dear doctor, your Hakkeem account is approved by Hakkeem authority.");
                                ...
                                Email_To_ApproveDoctor(email);
                                    ...
                                    //ClientScript.RegisterStartupScript(this.GetType(), "Success", "<Script Language=JavaScript>alert('Successfully Updated doctor and " + message + "');window.location='Doctor request.aspx';</Script>");
                                    //if (Session["Language"].ToString() == "Auto")
                                    //{
                                        Label1.Text = "Successfully Updated doctor and " + message;
                                    //}
                    ...
                    else
                    {
                        ...
                        if (FileUpload2.HasFile)
                        {
                            ...
                            if (extn == ".pdf" || extn == ".jpg")
                            {
                                ...
                                //////       Email.mail(email, msg, "Doctor registration");
                                Email_To_ApproveDoctor(email);
                                ob1.Message(ph.ToString(), "Dear doctor, your Hakkeem account is approved by Hakkeem authority.");
                                //ClientScript.RegisterStartupScript(this.GetType(), "Success", "<Script Language=JavaScript>alert('Successfully Updated doctor ');window.location='Doctor request.aspx';</Script>");
                                //if (Session["Language"].ToString() == "Auto")
                                //{
                                    Label1.Text = "Successfully Updated doctor.";
                                //}
                                //else
                                //{
    ...
    public bool Email_To_NewDoctor(string email, string hakkeemid, string password)
    {
        ...
        try
        {
            ...
            messagestr = messagestr + "<span style='color:#4aa9af'><a href='#' style='text-decoration:none;color:#4aa9af;font-size:11px'>Privacy policy</a>&nbsp;|&nbsp;<a href='" + contact + "' style='text-decoration:none;color:#4aa9af;font-size:11px'>Contact Us</a>";
