...
public partial class BookDoc_Admin_Del_Hospitals : System.Web.UI.Page
{
    ...
    {
        con.Open();
        SqlDataAdapter Sda = new SqlDataAdapter("Select * from tbl_temp_hospitalreg order by h_id desc", con);
