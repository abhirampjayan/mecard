<%@ Page Title="" Language="C#" MasterPageFile="~/BookDoc Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Del_Hdoctors.aspx.cs" Inherits="BookDoc_Admin_Del_Hdoctors" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">
                <asp:Label ID="Label5" runat="server" Text="Removed Hospital Doctors" meta:resourcekey="Label5Resource1"></asp:Label>
            </h3>
