<%@ Page Title="" Language="C#" MasterPageFile="~/BookDoc Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="appointmenthistory.aspx.cs" Inherits="BookDoc_Admin_appointmenthistory" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                        ...
                        <asp:GridView ID="GridView1" CssClass="table table-bordered" runat="server" AutoGenerateColumns="False" meta:resourcekey="GridView1Resource1">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Doctor" meta:resourcekey="TemplateFieldResource1">
                                    <ItemTemplate>
                                        <asp:Label ID="Label1"  runat="server" Text='<%# Bind("doctor") %>'></asp:Label>,
                                ...
                                <asp:TemplateField HeaderText="Hospital" meta:resourcekey="TemplateFieldResource2">
                                    <ItemTemplate>
                                        <asp:Label ID="Label3"  runat="server" Text='<%# Bind("hospital") %>' ></asp:Label>,
                                ...
                                <asp:TemplateField HeaderText="Patient" meta:resourcekey="TemplateFieldResource3">
                                    <ItemTemplate>
                                        <asp:Label ID="Label5"  runat="server" Text='<%# Bind("patient") %>'></asp:Label>,
