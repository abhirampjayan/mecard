                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">
                                    <asp:Label ID="Label33" runat="server" Text="Enter OTP" meta:resourcekey="Label33Resource1"></asp:Label>
...
<%--                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="* Enter contact number" ValidationGroup="bb" ForeColor="Red" ControlToValidate="textbox7" meta:resourcekey="RequiredFieldValidator3Resource1"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ValidationGroup="bb" ControlToValidate="TextBox7" runat="server" ErrorMessage="* Enter valid number" ForeColor="Red" Display="Dynamic" ValidationExpression="[6-9]{9}" meta:resourcekey="RegularExpressionValidator2Resource1"></asp:RegularExpressionValidator>--%>
                                                    <asp:TextBox ID="TextBox7" CssClass="form-control" TabIndex="3" TextMode="Phone" runat="server" ValidationGroup="bb" meta:resourcekey="TextBox7Resource1"></asp:TextBox>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-6 col-md-pull-6">
                                                    ...
                                                    <div class="form-group has-feedback">
                                                        ...
                                                        <asp:TextBox ID="TextBox4" CssClass="form-control datepicker" TabIndex="4" onkeydown="return false" onpaste="return false" ValidationGroup="bb" runat="server" meta:resourcekey="TextBox4Resource1" TextMode="Date"></asp:TextBox>
