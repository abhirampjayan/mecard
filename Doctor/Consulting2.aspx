<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor/DoctorMasterPage.master" AutoEventWireup="true" CodeFile="Consulting2.aspx.cs" Inherits="Doctor_Consulting" Culture="en-US" meta:resourcekey="PageResource1" UICulture="en-US" %>
                                        ...
                                        <Fields>
                                            ...
                                            <asp:TemplateField meta:resourcekey="TemplateFieldResource4">
                                                <ItemTemplate>
                                                    ...
                                                    |
                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandName="TestReports" CommandArgument='<%# Eval("email") %>' ForeColor="#98120F" Font-Bold="True" meta:resourcekey="LinkButton1Resource1">Test Reports</asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Fields>
                                    </asp:DetailsView>
