   ...
   public int i = 0;
    ...
    public void patient_details()
    {
        ...
        foreach (var ss in Query)
        {
            ...
            foreach (var ss1 in Query1)
            {
                Image img3 = DetailsView1.FindControl("Image3") as Image;
                if (ss1.photo == "" || ss1.photo == null)
                {
                    img3.ImageUrl = "../userimages/user.png";

                }
                else
                {
                    img3.ImageUrl = ss1.photo;
                }
            }
        }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            //if (Session["Language"].ToString() == "Auto")
            //{
                lblModalBody.Text = "Please explain the diagnosis and its prescription";
            //}
            //else
            //{
            //    lblModalBody.Text = "يرجى شرح التشخيص ووصفه";
            //}
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "myModal1", "$('#myModal1').modal();", true);
            upModal1.Update();
        }
    ...
    protected void BtnSubmitOTP_Click(object sender, EventArgs e)
    {
        ...
        //else
        //{
        //    Response.Redirect("~/Doctor/Today appointments.aspx?l=ar-EG");
        //}
    }
