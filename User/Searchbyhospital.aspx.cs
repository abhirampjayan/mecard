        ...
        if (!IsPostBack)
        {
            ...
            if (dtr.HasRows)
            {
                while (dtr.Read())
                {
                    ...
                    string pmqry = "select distinct(LTRIM(RIGHT(CONVERT(VARCHAR(20), GETDATE(), 100), 7))) as dt from tbl_hos_doc_time where date_id='" + dtr[0].ToString() + "'";
    ...
    public void list_doctors(string q, string docName, string location, string hosName)
    {
        ...
        //{
            ...
            if (q != "")
            {
                ...
                adpt = new SqlDataAdapter("select  distinct(hd_name) as d_name from  view_hos_doc_available_time  " + q + " and h_status='1'  and h_hakkimid not in (select hos_hakkeem_id from tbl_blk_hos_doctor)", con);
                dts.Clear();
            ...
            {
                adpt = new SqlDataAdapter("select  distinct(hd_name) as d_name from  view_hos_doc_available_time where h_status='1' and h_hakkimid not in (select hos_hakkeem_id from tbl_blk_hos_doctor)", con);
                dts.Clear();
            ...
            try
            {
                if (Session["q"] != "")
                {
                    adpt = new SqlDataAdapter("select  distinct(hd_name) as d_name from  view_hos_doc_available_time  " + Session["q"].ToString() + " and h_status='1' and h_hakkimid not in (select hos_hakkeem_id from tbl_blk_hos_doctor)", con);
                    dts.Clear();
            ...
            if (pagestart == 1)
            {
                ...
                if (q != "")
                {
                    ...
                    cmd = new SqlCommand("select  top 5  * from view_test_hos_doc where t>='" + pagestart + "' " + qqqq + "and h_status='1' and h_hakkimid not in (select hos_hakkeem_id from tbl_blk_hos_doctor) order by t", con);
                ...
                {
                    cmd = new SqlCommand("select  top 5    * from view_test_hos_doc where t>='" + pagestart + "' and h_status='1' and h_hakkimid not in (select hos_hakkeem_id from tbl_blk_hos_doctor) order by t", con);
            ...
            while (dr.Read())
            {
                ...
                string qry = "select * from tbl_hdoctor where hd_id='" + dr[3].ToString() + "' ";
                ...
                while (dr2.Read())
                {
                    Response.Write("<td><div id='btnover' onmouseover='hover(" + hosId + ")' onmouseout='out(" + hosId + ")'>");
                ...
                for (int i = 0; i < 30; i++)
                {
                    ...
                    if (j < 3)
                    {
                        ...
                        if (j == 0)
                        {
                            ...
                            qry = "select time,hd_email,hd_photo from view_hos_doc_available_time where hd_id='" + dr[3].ToString() + "' and date='" + cdateo + "' ";
                            ...
                            if (count1 == 0)
                            {
                                qry = "select time,hd_email,hd_photo from view_hos_doc_available_time where hd_id='" + dr[3].ToString() + "' and date='" + cdate1 + "' ";
                                ...
                                if (count2 == 0)
                                {
                                    qry = "select time,hd_email,hd_photo from view_hos_doc_available_time where hd_id='" + dr[3].ToString() + "' and date='" + cdate2 + "' ";
                            ...
                            if (Session["count"].ToString() == "1")
                            {
                                ...
                                string extqry = "select   top 1 date from view_hos_doc_available_time where hd_id='" + dr[3].ToString() + "' and date>'" + Session["cdate2"].ToString() + "'";
                            ...
                            else
                            {
                                ...
                                //       string cdate = dt.ToString("yyyy-MM-dd");
                                // DateTime  dte = Convert.ToDateTime(cdate);
                                qry = "select time,hd_email,hd_photo from view_hos_doc_available_time where hd_id='" + dr[3].ToString() + "' and date='" + cdate + "'";
                                ...
                                try
                                {
                                    ...
                                    if (dr1.HasRows)
                                    {
                                        ...
                                        while (dr1.Read())
                                        {
                                            ...
                                            if (test <= 3)
                                            {
                                                try
                                                {
                                                    ...
                                                    //}
                                                    //else 
                                                    ////0 - waiting, 1 - fixed, 3 - consulted, 4 - engaged
                                                    //2 - cancelled

                                                    if (a_status == 0 || a_status == 1 || a_status == 3 || a_status == 4)
                                                    {
                                                        Response.Write("<a title='Appointment Taken' class='btn btn-xs btn-success btn-hover btn' id='buttontime'>----</a>");
                                                    }
                                                    else
                                                    {

                                                        Response.Write("<a class='btn btn-xs btn-success btn-hover btn' id='buttontime' href=Hospitaldoctoravailability.aspx?docid=" + docidpass.ToString() + "&docdate=" + docdate.ToString() + "&doctime=" + doctime.ToString() + "&timeperiod=" + timeperiod.ToString() + "&Lat=" + lat.ToString() + "&Long=" + longti.ToString() + "&hospitalregno=" + hospitalId.ToString() + ">" + timet.ToString() + "</a>");
                                                ...
                                                catch (Exception ex)
                                                {
                                                    ...
                                                    Response.Write("<Label class='btn btn-xs btn-success btn-hover btn' id='buttontime'>----</Label>");
                                                    Response.Write("<br>");
                                                }
                                                test++;
                                            }
                                        ...
                                        if (test > 3)
                                        {
                                            ...
                                            Response.Write("<a class='btn btn-xs btn-success btn-hover btn btn' id='buttontime' href=Hospitaldoctoravailability.aspx?docid=" + docidpass + "&Lat=" + lat.ToString() + "&Long=" + longti + "&hospitalregno=" + hospitalId.ToString() + "> More</a>");
                                        }
                                    }
                                    else
                                    {
                                        ...
                                        { Response.Write("<Label class='btn btn-xs btn-success btn-hover btn btn' id='buttontime'>----</Label><br>"); }
                            ...
                            try
                            {
                                ...
                                if (dr1.HasRows)
                                {
                                    ...
                                    if (test > 3)
                                    {
                                        ...
                                        Response.Write("<a class='btn btn-xs btn-success btn-hover btn' id='buttontime' href=Hospitaldoctoravailability.aspx?docid=" + docidpass + "&Lat=" + lat.ToString() + "&Long=" + longti + "&hospitalregno=" + hospitalId.ToString() + "> More</a>");
                                    }
                                }
                                else
                                {
                                    Response.Write("<Label id='Datedisplay'>" + dt.ToString("ddd MMM dd") + "</Label></br>");
                                    for (int ii = 0; ii <= 4; ii++)
                                    { Response.Write("<Label class='btn btn-xs btn-success btn-hover btn' id='buttontime'>----</Label><br>"); }
      ...
      //  }
        ...
        //        // Start available date and time................................................................................
        //        Response.Write("<div class='ordering'>");
        ...
        //                            Response.Write("<label style='margin-top:50px; margin-left:30px' ><a  class='btn btn-success' href=?docid=" + docidpass.ToString() + "&docdate=" + docdate.ToString() + "&next=1> التالي التوفر " + nextdate.ToString() + "</a></label>");
        //                            //  Response.Write("<a href=?docid=" + dr[0].ToString() + "&docdate=" + Session["cdate2"].ToString() + " >Next availability</a>");
        //                            Response.Write("</div>");
        ...
        //                        {
        //                            nextdate = "";
        //                            Response.Write("<label  id='notavailable'><a href=?next=2  class='btn btn-success'><span id='available1'> غير متوفر في التواريخ المتبقية</span></a></label>");
        //                            //  Response.Write("<a href=?docid=" + dr[0].ToString() + "&docdate=" + Session["cdate2"].ToString() + " >Next availability</a>");
        //                            Response.Write("</div>");
        //                            break;
        //                            // dt.AddDays(2);
        ...
        //                                                Response.Write("<a class='btn btn-xs btn-success btn-hover btn' id='buttontime' href=Hospitaldoctoravailability.aspx?l=ar-EG&docid=" + docidpass.ToString() + "&docdate=" + docdate.ToString() + "&doctime=" + doctime.ToString() + "&timeperiod=" + timeperiod.ToString() + "&Lat=" + lat.ToString() + "&Long=" + longti.ToString() + "&hospitalregno=" + hospitalId.ToString() + ">" + timet.ToString() + "</a>");
        ...
        //                                    Response.Write("<a class='btn btn-xs btn-success btn-hover btn btn' id='buttontime' href=Hospitaldoctoravailability.aspx?l=ar-EG&docid=" + docidpass + "&Lat=" + lat.ToString() + "&Long=" + longti + "&hospitalregno=" + hospitalId.ToString() + "> More</a>");
        //                                }
        //                            }
        //                            else
        //                            {
        ...
        //                                Response.Write("<a class='btn btn-xs btn-success btn-hover btn' id='buttontime' href=Hospitaldoctoravailability.aspx?l=ar-EG&docid=" + docidpass + "&Lat=" + lat.ToString() + "&Long=" + longti + "&hospitalregno=" + hospitalId.ToString() + "> أكثر من</a>");
        //                            }
        //                        }
        //                        else
        //                        {
        ...
        //        Response.Write("<div class='col-md-4 o2'>");
        //        Response.Write("<div class='form-group'><p id='ardoctornameo'><a id='ardoctorname' href=Viewhospitaldoctorreview.aspx?l=ar-EG&docid=" + obj.EnryptString(dr25.ToString()) + "&Lat=" + Lat.ToString() + "&Long=" + Long.ToString() + ">" + dr[0].ToString() + "</a><p></div>");
        //        Response.Write(" <div class='form-group'><a id='arhospitalname' href=?hos=" + obj.EnryptString(dr[14].ToString()) + "&docid=" + obj.EnryptString(dr25.ToString()) + ">" + dr[10].ToString() + " </a></div>");
        //        Response.Write("<div class='form-group'><Label id='speciality1'>" + dr215.ToString() + "</Label></div>");
        //        Response.Write("<div class='form-group'><div id='armarker'><i id='armarker1' class='fa fa-map-marker'></i></div><div><Label id='aradress'> " + about.ToString() + " </Label></div></div>");
        //        Response.Write("</div>");

        //        // End Start doctor details....................................................................................
        ...
        //            if ((Request.QueryString["page"] == null || Request.QueryString["page"] == "" ) && p==1)
        //            {
        //                Response.Write("<li><a href=?page=" + p + "><font color='red'><u><b>" + p + "</b></u></font></a></li> ");
        //            }
        //            else
