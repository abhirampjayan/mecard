<%@ Page Title="" Language="C#" MasterPageFile="~/User/newUserMaster.master" Culture="auto" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="User_AbhinSearch" meta:resourcekey="PageResource2" UICulture="auto" %>
    ...
    <asp:ExtendedRequiredFieldValidator ID="ExtendedRequiredFieldValidator1" runat="server"
        ControlToValidate="DropDownCheckBoxes1" ErrorMessage="Required" ForeColor="Red"></asp:ExtendedRequiredFieldValidator>--%>
                ...
                <div class="inner-button">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <asp:DropDownList ID="DropDownList1" CssClass="searchdrop" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged1" meta:resourcekey="DropDownList2Resource2"></asp:DropDownList>
                    </div>
                    <div class="col-md-3 col-sm-6">
    ...
    <section id="skills">
        <div class="container">
             <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                       <asp:DropDownList ID="dgender" CssClass="searchsmalldrop" runat="server" AutoPostBack="True" OnSelectedIndexChanged="dgender_SelectedIndexChanged"  >
                           <asp:ListItem>--Gender--</asp:ListItem>
                           <asp:ListItem>Any Gender</asp:ListItem>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <asp:Button ID="Button3" CssClass="searchsmallbtn" runat="server" Text="Any gender" OnClick="Button3_Click" meta:resourcekey="Button3Resource2" Visible="false" />
                </div>
                <div class="col-md-2">
                    <asp:Button ID="Button4" CssClass="searchsmallbtn" runat="server" Text="Male" OnClick="Button4_Click1" meta:resourcekey="Button4Resource2" Visible="false" />
                </div>
                <div class="col-md-2">
                    <asp:Button ID="Button5" CssClass="searchsmallbtn" runat="server" Text="Female" OnClick="Button5_Click" meta:resourcekey="Button5Resource2" Visible="false"/>
                </div>
                <div class="col-md-3">
    ...
    <section class="content" style="background-color: #ecf0f5">
     ...
     <div class="loading" align="center">
           <%-- Loading. Please wait.<br />
            <br />--%>
            <img src="../pre_loader/loading.gif" style="height:50px;width:50px" alt="" />
        </div>
